...
describe('stateContent.ts', () => {
  ...
  it('should render state-card-content with correct hass and stateObj properties', async () => {
    const result = stateContent(mockHass, mockEntity);
  ...
  it('should apply the provided className when specified', async () => {
    ...
    const result = stateContent(mockHass, mockEntity, customClass);
    const el = await fixture(result as TemplateResult);
  ...
  it('should handle multiple class names correctly', async () => {
    ...
    const result = stateContent(mockHass, mockEntity, multipleClasses);
    const el = await fixture(result as TemplateResult);
